...
/**
 * Helper class for showing and canceling task list
 * notifications.
 * <p>
...
public class TaskNotificationList {
     ...
     */
    private static final String NOTIFICATION_TAG = "TaskList";
     ...
     * presentation of task list notifications. Make
     * sure to follow the
    ...
    public static void notify(final Context context,
        ...
        final String title = res.getString(
                R.string.task_list_notification_title_template, exampleString);
        final String text = res.getString(
                R.string.task_list_notification_placeholder_text_template, exampleString);
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_stat_task_list)
